...
export const projects: Project[] = [
  {
    ...
    tagline:
      "A unified B2B platform for vendor operations, communication, and inventory control.",
    features: [
    ...
    businessImpact:
      "Reduced vendor response time substantially and accelerated material and order management processes by approximately 70%. Improved data accuracy and operational efficiency across the procurement workflow.",
  ...
  },
  {
    ...
    tagline:
      "Digitizing institutional operations and empowering global education aspirations.",
    features: [
    ...
    businessImpact:
      "Modernized administrative operations for 5,000+ students and established a credible digital presence for the Sunshine Study Abroad brand, enabling effective outreach to prospective students across 8+ countries.",
    techStack: "Next.js · React.js · Firebase · Google Maps API · Tailwind CSS",
    liveLink: [
      {
        label: "Sunshine Study Abroad",
        url: "https://www.sunshinestudyabroad.in",
      },
      { label: "SIS Stage Platform", url: "https://stage-web.tsis.edu.in" },
      { label: "SIS ERP System", url: "https://erp.tsis.edu.in" },
      {
        label: "Sunshine College ERP",
        url: "https://erp.sunshinecollege.ac.in",
      },
    ],
  },
  {
    ...
    tagline:
      "Centralized legal file management with enterprise-grade data security.",
    features: [
    ...
    businessImpact:
      "Significantly improved the organization of legal records across branches, enhanced data security for sensitive client documentation, and reduced time spent locating and managing case files.",
  ...
  },
  {
    ...
    tagline:
      "An integrated financial management platform built for scale and clarity.",
    features: [
    ...
    businessImpact:
      "Enhanced financial visibility and reporting accuracy across the organization, reduced manual effort in collections management, and established a professional digital presence to support business development.",
  ...
  },
  {
    ...
    businessImpact:
      "Reduced inquiry response time and improved sales conversion rates by establishing a structured, accountable process for managing customer interactions across the organization.",
    techStack: "React.js · Node.js · REST APIs · Role-based Auth",
  ...
  },
  {
    ...
    tagline:
      "End-to-end digital infrastructure for B2B jewellery commerce and vendor engagement.",
    features: [
    ...
    businessImpact:
      "Established a strong digital presence for both businesses, streamlined vendor communication through automated WhatsApp notifications, and reduced manual inquiry handling through a structured CRM workflow.",
    techStack:
      "React.js · Node.js · Meta WhatsApp Business API · MongoDB · REST APIs",
    liveLink: [
  ...
  },
  {
    ...
    businessImpact:
      "Reduced manual bookkeeping overhead, minimized late payment incidents through proactive automated reminders, and provided the organization with real-time financial clarity accessible from any location.",
    techStack:
      "React.js · Node.js · MongoDB · Meta WhatsApp Business API · REST APIs",
    liveLink: [
  ...
  //   ],
  //   tagline:
  //     "Co-founding and engineering a high-end freelance collective built to deliver real results.",
  //   features: [
  ...
  //   ],
  //   businessImpact:
  //     "Established a credible, professional digital presence for the agency and contributed to building a service model that enables high-quality software delivery for clients across multiple domains.",
  ...
  // },
  {
    ...
    imgMain: "/projects/icebit_sub.svg",
    imgSub: "/projects/icebit_sub.svg",
    metrics: [
      { label: "SERVICES COVERED", value: "8+" },
      { label: "CONTENT AGILITY", value: "↑ 70%" },
    ],
    tagline:
      "Engineering the digital face of a leading IT solutions company — end to end.",
    features: [
    ...
    businessImpact:
      "Delivered a polished, professional digital presence that accurately represents Icebit Technologies. The paired CRM empowers the internal team to keep the website current — reducing turnaround time significantly.",
    techStack:
      "Next.js · React.js · Tailwind CSS · Node.js · REST APIs · Role-based Auth · Vercel",
    liveLink: [
