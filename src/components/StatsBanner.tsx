    ...
    <section className="w-full bg-[#C7F284] py-24 px-6 md:px-12 text-[#000000] my-20 lg:my-32">
      <div ref={statsRef} className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-12">
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <span className="stat-number font-display text-[58px] leading-[86px] font-[700] tracking-tight mb-2" data-value="3" data-suffix="+">3+</span>
        ...
        <div className="flex flex-col items-center justify-center text-center">
          <span className="stat-number font-display text-[58px] leading-[86px] font-[700] tracking-tight mb-2" data-value="10" data-suffix="+">10+</span>
